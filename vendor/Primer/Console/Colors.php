...
class Colors extends ConsoleObject
{
     ...
     */
    public static function decolorize($string)
    {
     ...
     */
    public static function cacheString($passed, $colorized, $colored)
    {
    ...
    {
        return self::safeStrPad($string, $length);
    }
